...
- The `helm.sh/chart` label is valid for any chart version: a long version cut to 63 characters on `.`, `_` or `-` no longer makes the API server refuse the chart's objects.
